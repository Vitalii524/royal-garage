...
app.post(
    "/api/debug/create-nazar-business-profile",
    requireAuth,
    async (req, res) => {
        try {
            const nazarId =
            ...
            if (
                ...
                return res.status(404).json({
                    ok: false,
                    message:
                        "Тип бізнесу car_service не знайдено."
                });
            }
            ...
            console.error(
                "Nazar business profile create error:",
                error
            );
            ...
            res.status(500).json({
                ok: false,
                message:
                    "Не вдалося створити бізнес-профіль Назара."
            });
        }
    }
);
